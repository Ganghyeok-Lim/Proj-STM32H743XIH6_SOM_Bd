...
void HAL_DAC_MspDeInit(DAC_HandleTypeDef* hdac)
{
  ...
  /* USER CODE END DAC1_MspDeInit 0 */
    ...
    PA4     ------> DAC1_OUT1
    */
    HAL_GPIO_DeInit(GPIOA, MCU_DAC1_OUT2_Pin|MCU_DAC1_OUT1_Pin);
...
void HAL_FDCAN_MspDeInit(FDCAN_HandleTypeDef* hfdcan)
{
  ...
  /* USER CODE END FDCAN1_MspDeInit 0 */
    ...
    PB9     ------> FDCAN1_TX
    */
    HAL_GPIO_DeInit(MCU_FDCAN1_RX_GPIO_Port, MCU_FDCAN1_RX_Pin);

    HAL_GPIO_DeInit(MCU_FDCAN1_TX_GPIO_Port, MCU_FDCAN1_TX_Pin);
...
void HAL_I2C_MspDeInit(I2C_HandleTypeDef* hi2c)
{
  ...
  /* USER CODE END I2C2_MspDeInit 0 */
    ...
    PF0     ------> I2C2_SDA
    */
    HAL_GPIO_DeInit(MCU_I2C2_SCL_GPIO_Port, MCU_I2C2_SCL_Pin);

    HAL_GPIO_DeInit(MCU_I2C2_SDA_GPIO_Port, MCU_I2C2_SDA_Pin);
  ...
  /* USER CODE END I2C3_MspDeInit 0 */
    ...
    PH7     ------> I2C3_SCL
    */
    HAL_GPIO_DeInit(MCU_I2C3_SDA_GPIO_Port, MCU_I2C3_SDA_Pin);

    HAL_GPIO_DeInit(MCU_I2C3_SCL_GPIO_Port, MCU_I2C3_SCL_Pin);
...
void HAL_I2S_MspDeInit(I2S_HandleTypeDef* hi2s)
{
  ...
  /* USER CODE END SPI2_MspDeInit 0 */
    ...
    PC6     ------> I2S2_MCK
    */
    HAL_GPIO_DeInit(GPIOI, MCU_I2S2_CK_Pin|MCU_I2S2_WS_Pin|MCU_I2S2_SDI_Pin|MCU_I2S2_SDO_Pin);

    HAL_GPIO_DeInit(MCU_I2S2_MCK_GPIO_Port, MCU_I2S2_MCK_Pin);
...
void HAL_OPAMP_MspDeInit(OPAMP_HandleTypeDef* hopamp)
{
  ...
  /* USER CODE END OPAMP1_MspDeInit 0 */
    ...
    PB0     ------> OPAMP1_VINP
    */
    HAL_GPIO_DeInit(MCU_OPAMP1_VINM_GPIO_Port, MCU_OPAMP1_VINM_Pin);

    HAL_GPIO_DeInit(MCU_OPAMP1_VOUT_GPIO_Port, MCU_OPAMP1_VOUT_Pin);

    HAL_GPIO_DeInit(MCU_OPAMP1_VINP_GPIO_Port, MCU_OPAMP1_VINP_Pin);
  ...
  /* USER CODE END OPAMP2_MspDeInit 0 */
    ...
    PE7     ------> OPAMP2_VOUT
    */
    HAL_GPIO_DeInit(GPIOE, MCU_OPAMP2_VINP_Pin|MCU_OPAMP2_VINM_Pin|MCU_OPAMP2_VOUT_Pin);
...
void HAL_SD_MspDeInit(SD_HandleTypeDef* hsd)
{
  ...
  /* USER CODE END SDMMC1_MspDeInit 0 */
    ...
    PC9     ------> SDMMC1_D1
    */
    HAL_GPIO_DeInit(GPIOC, MCU_SDMMC1_D2_Pin|MCU_SDMMC1_D3_Pin|MCU_SDMMC1_CK_Pin|MCU_SDMMC1_D0_Pin
                          |MCU_SDMMC1_D1_Pin);

    HAL_GPIO_DeInit(MCU_SDMMC1_CMD_GPIO_Port, MCU_SDMMC1_CMD_Pin);
...
void HAL_SPI_MspDeInit(SPI_HandleTypeDef* hspi)
{
  ...
  /* USER CODE END SPI1_MspDeInit 0 */
    ...
    PG11     ------> SPI1_SCK
    */
    HAL_GPIO_DeInit(MCU_SPI1_MOSI_GPIO_Port, MCU_SPI1_MOSI_Pin);

    HAL_GPIO_DeInit(GPIOG, MCU_SPI1_MISO_Pin|MCU_SPI1_SCK_Pin);
  ...
  /* USER CODE END SPI4_MspDeInit 0 */
    ...
    PE6     ------> SPI4_MOSI
    */
    HAL_GPIO_DeInit(GPIOE, MCU_SPI4_SCK_Pin|MCU_SPI4_MISO_Pin|MCU_SPI4_MOSI_Pin);
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* huart)
{
  ...
  /* USER CODE END UART8_MspDeInit 0 */
    ...
    PE0     ------> UART8_RX
    */
    HAL_GPIO_DeInit(GPIOE, MCU_UART8_TX_Pin|MCU_UART8_RX_Pin);
  ...
  /* USER CODE END USART1_MspDeInit 0 */
    ...
    PA9     ------> USART1_TX
    */
    HAL_GPIO_DeInit(GPIOA, MCU_USART1_RX_Pin|MCU_USART1_TX_Pin);
  ...
  /* USER CODE END USART2_MspDeInit 0 */
    ...
    PA3     ------> USART2_RX
    */
    HAL_GPIO_DeInit(MCU_USART2_TX_GPIO_Port, MCU_USART2_TX_Pin);

    HAL_GPIO_DeInit(MCU_USART2_RX_GPIO_Port, MCU_USART2_RX_Pin);
